...
add wave -noupdate /cpu_tb/dut/latest_instruction
...
add wave -noupdate /cpu_tb/dut/bd/zero
add wave -noupdate /cpu_tb/dut/bd/neg
add wave -noupdate /cpu_tb/dut/bd/c_out
add wave -noupdate /cpu_tb/dut/bd/over
add wave -noupdate /cpu_tb/dut/bd/branch_taken
add wave -noupdate /cpu_tb/dut/p_jump
add wave -noupdate /cpu_tb/dut/p_pc_src
add wave -noupdate -radix decimal -childformat {{{/cpu_tb/dut/p_jump_addr[0]} -radix decimal}} -subitemconfig {{/cpu_tb/dut/p_jump_addr[0]} {-height 15 -radix decimal}} /cpu_tb/dut/p_jump_addr
...
add wave -noupdate -radix decimal /cpu_tb/dut/dm/address
...
WaveRestoreCursors {{Cursor 1} {4764395 ps} 0}
...
update
WaveRestoreZoom {4764126 ps} {4766152 ps}
