...
add wave -noupdate -radix decimal -childformat {{{/cpu_tb/dut/p_i_addr[1]} -radix decimal} {{/cpu_tb/dut/p_i_addr[0]} -radix decimal}} -expand -subitemconfig {{/cpu_tb/dut/p_i_addr[1]} {-radix decimal} {/cpu_tb/dut/p_i_addr[0]} {-radix decimal}} /cpu_tb/dut/p_i_addr
...
WaveRestoreCursors {{Cursor 1} {931 ps} 0}
...
update
WaveRestoreZoom {776 ps} {2016 ps}
